...
public final class Client {
  ...
  /**
   * Retrieve course summaries for a summary.
   *
  ...
  /**
   * Retrieve course rating for a summary.
   *
   * @param summary the summary to retrieve
   * @param clientID the id to retrieve
   * @param callbacks the callback that will receive the result
   */
  public void getRating(
    ...
    StringRequest ratingRequest =
            new StringRequest(
                    ...
                    response -> {
                      try {
                        Rating ratings = objectMapper.readValue(response, Rating.class);
                        callbacks.yourRating(summary, ratings);
                      } catch (JsonProcessingException e) {
                        e.printStackTrace();
                      }
                      /*
  ...
  public void postRating(
    ...
    StringRequest ratingRequest =
      ...
      public byte[] getBody() {
        ...
        try {
          ratingString = objectmapper.writeValueAsString(rating);
        } catch (JsonProcessingException e) {
          e.printStackTrace();
        }
